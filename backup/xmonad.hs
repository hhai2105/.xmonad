...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_d ), spawn $ mySearch)
  , ((modMask, xK_h), spawn $ " 'htop task manager' -e htop" )
  ...
  -- FUNCTION KEYS
  , ((0, xK_F12), spawn $ myTerminal )

  -- SUPER + SHIFT KEYS

  , ((modMask .|. shiftMask , xK_Return ), spawn $ mySearch)
  ...
  , ((controlMask .|. mod1Mask , xK_b ), spawn $ myFileExplorer)
  , ((controlMask .|. mod1Mask , xK_w ), spawn $ myBrowser)
  , ((controlMask .|. mod1Mask , xK_e ), spawn $ myEditor)
  -- , ((controlMask .|. mod1Mask , xK_k ), spawn $ "arcolinux-logout")
  , ((controlMask .|. mod1Mask , xK_n ), spawn $ myNote)
  ...
  --Wacom Monitor
  , ((controlMask, xK_F11), spawn $ "wacom_main")
  , ((controlMask, xK_F12), spawn $ "wacom_side")
  ...
  -- Increase brightness
  , ((0, xF86XK_MonBrightnessUp),  spawn $ "lux -a 1000")

  -- Decrease brightness
  , ((0, xF86XK_MonBrightnessDown), spawn $ "lux -s 1000")
...
--  , ((0, xF86XK_AudioStop), spawn $ "mpc stop")
  ...
  --Fullscreen Desktop
  , ((modMask, xK_f), sendMessage (MT.Toggle NBFULL) >> sendMessage ToggleStruts)     -- Toggles struts

  --Fullscreen Desktop
  , ((modMask, xK_b), withFocused toggleBorder)     -- Toggles struts
